function carregar() {
    ...
    fimg.src="pexels-nicolas-postiglioni-421129.jpg"

    if (hora < 12) { //Horario da manhã

        dive02.innerHTML = "Bom dia meu polvo."
        bcorpo.style.backgroundColor = "#313b72"
        bcorpo.style.backgroundImage = "url('sites/manha_tarde_noite/assets/img/pexels-pixabay-163323.jpg')"
        secao.style.backgroundColor = "rgba(0,0,0,0.1)"
        fimg.src="sites/manha_tarde_noite/assets/img/pexels-pixabay-163323.jpg"
        ...
        bcorpo.style.backgroundImage = "url('sites/manha_tarde_noite/assets/img/pexels-marko-obrvan-306344.jpg')"
        //Para mudar a img com JavaScript
        fimg.src = "sites/manha_tarde_noite/assets/img/pexels-marko-obrvan-306344.jpg"
        secao.style.backgroundColor = "rgba(0,0,0,0.1)"
        secao.style.color = "white"
        ...
        // Estilo do body
        bcorpo.style.backgroundImage = "url('sites/manha_tarde_noite/assets/img/pexels-nicolas-postiglioni-421129.jpg')"
        // Estilo da cor do body
        bcorpo.style.backgroundColor = "#2C133C"
        // Mpdificando a imagem da tag img
        fimg.src = "sites/manha_tarde_noite/assets/img/pexels-nicolas-postiglioni-421129.jpg"
        // texto na cor branca
        secao.style.color = "white"
    }
}